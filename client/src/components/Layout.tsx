        ...
        {mobileMenuOpen && (
          <div className="sm:hidden">
            <div className="pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
              ...
              {/* Mobile System Pages Section */}
              <div className="border-t border-gray-200 mt-3 pt-3">
                <div className="px-4 py-2">
                  <p className="text-sm font-medium text-gray-500 uppercase tracking-wide">System Pages</p>
                </div>
                {systemPages.map((page) => {
                  const Icon = page.icon;
                  return (
              ...
              {/* Mobile Testing Pages Section */}
              <div className="border-t border-gray-200 mt-3 pt-3">
                <div className="px-4 py-2">
                  <p className="text-sm font-medium text-gray-500 uppercase tracking-wide">Testing & Debug</p>
                </div>
                {testingPages.map((page) => {
                  const Icon = page.icon;
                  return (
