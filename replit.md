...
- June 20, 2025. Auto-save draft functionality enhanced - created dedicated API endpoints for saving draft content (/sessions/:id/draft-ibos, /sessions/:id/draft-activities, /sessions/:id/lock-ibos, /sessions/:id/unlock-ibos), refactored useAIContent hook to use new saveDraftIBOs and saveDraft4C API methods, improved error handling and auto-persistence of AI-generated content edits, provides seamless auto-save experience for all AI content modifications
